    ...
    for expert_iteration in range(NUM_EXPERT_ITERATIONS):
        ...
        for epoch in range(NUM_EPOCHS):
            ...
            for i in range(len(expert_batch) // BATCH_SIZE):
                print(f"Batch Size {BATCH_SIZE}, Expert Iteration {expert_iteration}, Epoch {epoch}, Batch {i}/{len(expert_batch) // BATCH_SIZE}")
            ...
            with torch.no_grad():
                print(f"Expert Iteration {expert_iteration}, Epoch {epoch}, Batch Size {BATCH_SIZE}, Evaluating...")
                ...
                wandb.log({"val_accuracy": val_accuracy, "epoch": epoch, "expert_iteration": expert_iteration, "batch_size": BATCH_SIZE}) 
