...
for grpo_iteration in range(NUM_GRPO_ITERATIONS):
    ...
    for epoch in range(EPOCHS_PER_ROLLOUT_BATCH):
        ...
        for i in range(0, TRAIN_BATCH_SIZE // micro_train_batch_size):
            ...
            wandb.log({"rewards": raw_rewards[batch_indices].mean(), "advantages": advantages[batch_indices].mean(), "gradient_norms": grad_norm, "total_samples_processed": total_samples_processed, "percentage_clipped": metadata["clipped_or_not"].float().mean()})
