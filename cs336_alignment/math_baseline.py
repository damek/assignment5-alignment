...
dataset_r1_zero=data_set_to_prompt_response_answer(dataset)
...
rewards, responses=evaluate_vllm(model, r1_zero_reward_fn, dataset_r1_zero, eval_sampling_params)
if not os.path.exists("outputs"):
    os.makedirs("outputs")

serialize_to_disk(dataset_r1_zero, responses, rewards, eval_sampling_params, OUTPUT_PATH)
...
print("Printing format reward 1 and answer reward 1...")
print_format_reward_1_answer_reward_1(rows, 10)
print(histogram)
